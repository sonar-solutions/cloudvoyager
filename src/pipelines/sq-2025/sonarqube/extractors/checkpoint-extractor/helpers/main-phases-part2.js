...
// -------- Main Phases Part 2 (Steps 6-10) --------

/** Build phases 6 through 10 for main branch extraction. */
export function buildMainPhasesPart2(extractor, ctx, maxFiles, sourceConcurrency, dupConcurrency) {
  return [
