...
// -------- Branch Phases Part 1 (components, files, issues, hotspots) --------

/** Build the first group of branch extraction phases. */
export function buildBranchPhasesPart1(extractor, ctx, branch, metricKeys) {
  return [
