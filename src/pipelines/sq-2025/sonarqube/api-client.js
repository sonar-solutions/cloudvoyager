...
export class SonarQubeClient {
  ...
  async getIssues(filters = {}) {
    const params = { componentKeys: this.projectKey, issueStatuses: 'OPEN,CONFIRMED,FALSE_POSITIVE,ACCEPTED,FIXED', ...filters };
  ...
  async getIssuesWithComments(filters = {}) {
    const params = { componentKeys: this.projectKey, additionalFields: 'comments', issueStatuses: 'OPEN,CONFIRMED,FALSE_POSITIVE,ACCEPTED,FIXED', ...filters };
  ...
  async getGroups() {
    try {
      return await perm.getGroups(this.getPaginated.bind(this));
    } catch (error) {
