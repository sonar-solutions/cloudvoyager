...
// -------- Phase 2: Single Project Metadata Sync --------

export async function migrateOneProjectMetadata(phase2Ctx) {
  const { project, scProjectKey, org, ctx, results, projectResult, projectStart, reportUploadOk, projectSqClient, projectScClient, isStepDone, recordStep, shouldRun, only } = phase2Ctx;
