...
import { mapVulnerabilityProbability } from './helpers/map-vulnerability-probability.js';

// -------- Extract Hotspots as Issue-Compatible Objects --------
...
export async function extractHotspotsAsIssues(client, branch = null) {
  ...
  return validHotspots.map(hotspot => ({
    key: hotspot.key, rule: hotspot.ruleKey,
    severity: mapVulnerabilityProbability(hotspot.vulnerabilityProbability),
    component: hotspot.component, project: hotspot.project,
    line: hotspot.line, textRange: hotspot.textRange || null,
    flows: hotspot.flows || [], status: hotspot.status,
    message: hotspot.message, author: hotspot.author,
