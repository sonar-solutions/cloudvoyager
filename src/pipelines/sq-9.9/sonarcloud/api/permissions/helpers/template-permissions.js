...
// -------- Permission Template API Methods --------
...
export async function addGroupToTemplate(client, organization, templateId, groupName, permission) {
  ...
  await client.post('/api/permissions/add_group_to_template', null, { params: { templateId, groupName, permission, organization } });
}
...
export async function setDefaultTemplate(client, organization, templateId, qualifier = 'TRK') {
  ...
  await client.post('/api/permissions/set_default_template', null, { params: { templateId, qualifier, organization } });
}
