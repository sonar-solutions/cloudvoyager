...
import { createLanguageSanitizer } from './helpers/sanitize-language.js';
import { buildFileComponents } from './helpers/build-file-components.js';

// -------- Build Component Messages --------
...
export function buildComponents(builder) {
  ...
  componentsMap.set(project.key, {
    ref: builder.getComponentRef(project.key), type: 1, childRef: [],
  ...
  buildFileComponents(builder, componentsMap, sourceInfo, sourceKeys, sanitizeLang);
