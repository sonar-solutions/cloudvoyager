...
// Log a human-readable summary of the migration run.
...
function logProjectKeyWarnings(results) {
  if (results.projectKeyWarnings.length === 0) return;
...
function logNewCodePeriodWarnings(results) {
