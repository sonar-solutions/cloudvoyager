...
/** Map SQ issue type string to IssueType protobuf enum value. */
export function mapIssueType(type) {
  const typeMap = { 'CODE_SMELL': 1, 'BUG': 2, 'VULNERABILITY': 3, 'SECURITY_HOTSPOT': 4 };
  return typeMap[type] || 1;
}

/** Map SQ type/quality name to SoftwareQuality protobuf enum value. */
...
/** Map SQ impact severity to ImpactSeverity enum value. */
...
/** Derive a default cleanCodeAttribute from issue type. */
